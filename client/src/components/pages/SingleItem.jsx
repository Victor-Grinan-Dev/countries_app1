...
function SingleItem() {
  ...
  const openWeatherUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=${process.env.REACT_APP_OPEN_WEATHER_MAP_KEY}`;
  ...
  useEffect(() => {
    ...
    try {
      ...
      setError("Error in useEffect: " + err);
    }
  ...
  return (
    ...
    >
      ...
      <p>
        Capital: {capital} - (Weather station: {weatherStation})
      </p>
      <p>Temp: {temp}°C</p>
